...
- Dataset: `/Data/wyh/datasets/Verl-Data/train/textcraft/entropy_based_prefix/stage6_training_build/textcraft_prefix_entropy_raw_topk_interaction_user_k3_step200.prompt_space_recomputed.full.parquet`
- Rows: `3026`
- Passed: `True`
...
- Missing columns: `[]`
- Strategy values: `['entropy_raw_topk_interaction_user_k3']`
...
- Replay category counts: `{'validated': 3026}`
- Candidate rank counts: `{1: 962, 2: 1068, 3: 996}`
- Unique sample_uid: `1247`
- Duplicate sample_uid: `1779`
- Empty prefix_actions: `0`
- Multi-action-like rows: `33`
