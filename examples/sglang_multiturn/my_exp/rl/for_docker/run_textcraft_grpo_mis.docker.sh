...
# ============================================================
# TextCraft GRPO + MIS 训练脚本 (Docker 容器内版本)
#
...
OUTPUT_DIR=${OUTPUT_DIR:-"/workspace/outputs/textcraft_grpo_mis"}

# -------------------- GPU配置 --------------------
GPU_IDS=${GPU_IDS:-"0,1,2,3,4,5,6,7"}  # 默认8卡
NUM_GPUS=${NUM_GPUS:-8}
...
ROLLOUT_IS=${ROLLOUT_IS:-"sequence"}        # 开启 IS
ROLLOUT_IS_THRESHOLD=${ROLLOUT_IS_THRESHOLD:-2.0}
ROLLOUT_RS=${ROLLOUT_RS:-"sequence"}        # 开启 MIS
...
# ==================== 打印配置 ====================
echo "================================================================================" | tee "$LOG_FILE"
echo "  TextCraft GRPO+MIS训练 - Docker 容器内版本" | tee -a "$LOG_FILE"
echo "================================================================================" | tee -a "$LOG_FILE"
echo "" | tee -a "$LOG_FILE"
